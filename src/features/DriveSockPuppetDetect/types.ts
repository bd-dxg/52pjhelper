 ...
 */
export interface DriveSockPuppetItem {
  forumId: string
 ...
 * 马甲数据类型
 */
export type DriveSockPuppetData = DriveSockPuppetItem[]
 ...
 * 用户马甲管理器接口
 */
export interface IDriveSockPuppetDetect {
  /** 启用功能 */
  enable(): Promise<void>
  /** 禁用功能 */
  ...
  getStatus(): boolean
  /** 手动更新马甲数据 */
  updateData(data: DriveSockPuppetData): Promise<void>
  /** 获取马甲数据 */
  getData(): Promise<DriveSockPuppetData>
  /** 检查是否需要自动更新 */
