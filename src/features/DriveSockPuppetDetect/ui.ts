import type { DriveSockPuppetData, DriveSockPuppetItem } from './types'
...
export const injectStyles = (): void => {
  ...
  styleElement.textContent = `
    ...
    .drive-sock-puppet-popup.show {
      display: block !important;
    }
    .drive-sock-puppet-popup table {
      width: 100% !important;
      border-collapse: collapse !important;
      margin-top: 5px !important;
    }
    .drive-sock-puppet-popup table th,
    .drive-sock-puppet-popup table td {
    ...
    .drive-sock-puppet-popup .no-data {
      text-align: center !important;
      color: #666 !important;
      padding: 10px !important;
    }
    .drive-sock-puppet-tag {
      color: red !important;
      font-size: 14px !important;
...
export const getOrCreatePopup = (): HTMLDivElement => {
  if (!currentPopup) {
    ...
    currentPopup.className = 'drive-sock-puppet-popup'
...
export const showUserInfo = (
  ...
  // 查找用户数据
  const userData = sockPuppetData.find(item => item.forumId.toLowerCase() === forumId.toLowerCase())
